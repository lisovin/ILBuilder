...
type IL private () =     
    ...
    static member callvirt (cons : ConstructorInfo) = Emit.EmitConstructor(OpCodes.Callvirt, cons)
    static member callvirt (cons : System.Reflection.ConstructorInfo) = Emit.EmitConstructor(OpCodes.Callvirt, cons)
