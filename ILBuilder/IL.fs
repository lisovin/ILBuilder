...
type IL private () =     
    ...
    static member beginCatchBlock(exceptionType) = fun (il : ILGenerator, u : Universe) -> il.BeginCatchBlock(u.Import(exceptionType))
    static member beginExceptionBlock() = fun (il : ILGenerator) -> il.BeginExceptionBlock()
    ...
    static member defineLabel() = fun (il : ILGenerator) -> il.DefineLabel()
    static member endExceptionBlock = fun (il : ILGenerator) -> il.EndExceptionBlock()
